...
CREATE TABLE `wechat_user`  (
  ...
  `id_card` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '身份证',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `is_addfzjsf` int(1) NULL DEFAULT 1 COMMENT '是否添加至接收方，1：没有，2：已添加',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '微信用户表' ROW_FORMAT = Compact;

DROP TABLE IF EXISTS `wechat_pay_order`;
CREATE TABLE `wechat_pay_order`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
  `order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'order_no',
  `order_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '订单名',
  `order_status` int(1) NULL DEFAULT 1 COMMENT '是否验证通过，1：否，2：是',
	`pay_status` int(1) NULL DEFAULT 1 COMMENT '是否支付成功，1：否，2：是',
  `pay_order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '商户支付订单编号',
	`pay_wx_order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '微信支付订单编号',
	`pay_wx_order_amount` double(10,2) NULL COMMENT '支付金额',
	`separate_status` int(1) NULL DEFAULT 1 COMMENT '是否支付成功，1：否，2：是',
	`separate_wx_order_no` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci  NULL COMMENT '微信分账订单编号',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  `pay_order_time` datetime NULL COMMENT '支付时间',
	`separate_time` datetime NULL COMMENT '分账时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分账主表' ROW_FORMAT = Compact;



DROP TABLE IF EXISTS `wechat_pay_order_user`;
CREATE TABLE `wechat_pay_order_user`  (
  `id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'id',
	`pay_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '主表id',
  `open_id` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'openId',
  `user_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '用户名称',
  `telphone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '手机号',
  `id_card` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '身份证',
	`bind_status` int(1) NULL DEFAULT 1 COMMENT '是否绑定，1：否，2：是',
	`receive_status` int(1) NULL DEFAULT 1 COMMENT '是否为分账接收方，1：否，2：是',
	`separate_amount` double(10,2) NULL COMMENT '分账金额',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分账用户表' ROW_FORMAT = Compact;
