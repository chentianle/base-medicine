...
public class CodeDOM {
    ...
    private CodeDOM(String tableName) {
        ...
        basePackage_ = "cn/huanzi/qch/baseadmin/medicine/";
     ...
     * 数据连接相关
     */
    private static final String URL = "jdbc:mysql://43.143.201.195:3306/medicine?serverTimezone=GMT%2B8&characterEncoding=utf-8";
    private static final String USERNAME = "root";
    private static final String PASSWORD = "Yunding@%#1104";
