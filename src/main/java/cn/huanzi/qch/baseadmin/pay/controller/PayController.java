package cn.huanzi.qch.baseadmin.pay.controller;
...
public class PayController {
    ...
    public ModelAndView list() {
        ...
        return new ModelAndView("pay/list/list", "list", sysUserVo);
    }


    @GetMapping("listPayLog")
    public ModelAndView listPayLog() {
        SysUserVo sysUserVo = sysUserService.findByLoginName(SecurityUtil.getLoginUser().getUsername()).getData();
        sysUserVo.setPassword(null);
        return new ModelAndView("pay/listPayLog/listPayLog", "user", sysUserVo);
    }
