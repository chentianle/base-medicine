...
public class DosageParser {
    public DosageSpec dosageChuli(String input) throws Exception{
        String pattern = "\\s*(\\d+)次[\\s\\S]*次(\\d+(\\.\\d+)?)(ml|g|cl|mg|片|瓶|支|板|粒|片/盒|S|袋|IU|iu|包|克|喷|丸|毫克|丸|枚|s|贴|揿|ug|单位|钦)";
        ...
        String patternV1 = "\\s*次(\\d+(\\.\\d+)?)(ml|g|cl|mg|片|瓶|支|板|粒|片/盒|S|袋|IU|iu|包|克|喷|丸|毫克|丸|枚|s|贴|揿|ug|单位|钦)[\\s\\S]*(\\d+)次";
